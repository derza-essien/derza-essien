...
| FPGA-Accelerated Crypto High Frequency Trading System | Hardware Design Lead | SystemVerilog, PYNQZ1, Xilinx Vivado | Designed the RTL for the fixed-point matrix multiplier for a linear regression model |
...
The list below explains in more depth what the prior mentioned projects consist of, as well as more information my specific contributions, as well as their impacts.
